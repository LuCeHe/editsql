...
#"/home/lily/rz268/dialog2sql/word_emb/glove.840B.300d.txt" # you need to change this
...
--embedding_filename='data\glove.840B.300d.txt' \
...
python3 postprocess_eval.py --dataset=sparc --split=dev --pred_file logs_sparc_editsql/valid_use_predicted_queries_predictions.json --remove_from
